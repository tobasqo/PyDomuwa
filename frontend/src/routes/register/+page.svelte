    ...
    <div class="w-full rounded-lg bg-orange shadow sm:max-w-md">
      <div class="space-y-4 p-6 sm:p-8 md:space-y-6">
        ...
        <form class="space-y-4 md:space-y-6" action="/register" method="post">
          ...
          <button
            type="submit"
            class="hover:bg-primary-700 focus:ring-primary-300 w-full rounded-lg bg-lilac px-5 py-2.5 text-center text-sm font-medium text-white shadow-lg hover:bg-dark focus:outline-none focus:ring-4"
          >
            Zarejestruj się
          </button>
        </form>
